...
public static partial class Ipc
{
    ...
    public static class ConvertTextureFile
    {
        ...
        public static FuncProvider< string, string, TextureType, bool, Task > Provider( DalamudPluginInterface pi, Func< string, string, TextureType, bool, Task > func )
            => new(pi, Label, func);
    ...
    public static class ConvertTextureData
    {
        ...
        public static FuncProvider< byte[], int, string, TextureType, bool, Task > Provider( DalamudPluginInterface pi, Func< byte[], int, string, TextureType, bool, Task > func )
            => new(pi, Label, func);
